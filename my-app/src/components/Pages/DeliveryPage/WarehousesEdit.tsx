...
interface WarehousesEditProps {
    columns: any;
    setColumns: ({}: any) => any;
    sellerId: string;
    sortingType: string;
    setSortingType: (arg: string) => any;
}
...
export const WarehousesEdit = ({
    ...
    const arrayMoveWrapper = (arrayTemp: any[], oldIndex: number, newIndex: number) => {
    ...
    const sortItems = (sortingParam: string, data = undefined as any) => {
        setItems((prevItems) =>
            data
                ? data.sort((a: any, b: any) => a[sortingParam] - b[sortingParam])
