...
export const ManageDeletionOfOldPlansModal = ({
    ...
    const handleDeletePlansButton = () => {
        const params = {
            ...
            monthNames: selectedMonth[0] == monthNames[0] ? monthNames : selectedMonth,
            metrics: currenrPlanModalMetrics,
            entities: [] as any[],
        };
        for (const row of filteredData) {
            const {entity} = row;
            if (!params.entities.includes(entity)) params.entities.push(entity);
        }
        console.log(params);
                        ...
                        <List
                            ...
                            renderItem={(item) => {
                                const selected = currenrPlanModalMetrics.includes(
                                    (columnDataReversed as any)[item],
                                );
                            ...
                            onItemClick={(item) => {
                                const metricVal = (columnDataReversed as any)[item];
