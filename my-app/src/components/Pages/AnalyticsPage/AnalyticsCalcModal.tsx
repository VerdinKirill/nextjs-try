...
interface AnalyticsCalcModalProps {
    setEntityKeysLastCalc: (arg?: any) => any;
    setEnteredKeysDateTypeLastCalc: (arg?: any) => any;
    doc: any;
            ...
            temp.push(
                ...
                >
                    <Switch
                        ...
                        onUpdate={(val) => {
                            const newVal: any = {...enteredKeysCheck};
                            newVal[key] = val;
                    ...
                    >
                        <Button
                            ...
                            onClick={() => {
                                ...
                                const tempEnteredKeysCheck: any = {...enteredKeysCheck};
