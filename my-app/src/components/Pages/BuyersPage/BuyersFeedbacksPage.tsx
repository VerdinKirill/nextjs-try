...
export const BuyersFeedbacksPage = ({
    ...
    const [artsTags, setArtsTags] = useState<any>({});

    const [artsData, setArtsData] = useState<any>({});
            ...
            >
                ...
                <Tooltip content="Телеграм бот для ответов на вопросы покупателей">
                    ...
                    >
                        ...
                        <Text variant="subheader-1">Бот для ответов на вопросы</Text>
                    </Button>
                </Tooltip>
            </div>
            <TheTable
                ...
                onPaginationUpdate={({page}: any) => setCurrentPage(page)}
